...
import '../controller/verify_forgot_otp_controller.dart';

class VerifyForgotOtpScreen extends StatelessWidget {
  VerifyForgotOtpScreen({super.key});

  final VerifyForgotOtpController controller = Get.find();
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              CustomButton(
                onPressed: () {
                  Get.toNamed(AppRoute.createNewPassScreen);
                },
                text: "Verify",
